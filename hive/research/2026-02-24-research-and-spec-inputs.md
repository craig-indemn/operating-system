---
title: What data, architecture, and design inputs do we need to spec the Observatory
...
# What data, architecture, and design inputs do we need to spec the Observatory usage analytics feature?
