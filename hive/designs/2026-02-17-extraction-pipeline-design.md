---
title: How do we extract structured data from 2,195 call transcripts to build an AI
  agent capability document for Alliance I...
tags:
- design
- architecture
domains:
...
# How do we extract structured data from 2,195 call transcripts to build an AI agent capability document for Alliance I...
