---
title: How to build an operating system that orchestrates Claude Code sessions to
  do dev work across repos, with persistent ...
tags:
- design
- architecture
domains:
...
# How to build an operating system that orchestrates Claude Code sessions to do dev work across repos, with persistent ...
